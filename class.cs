...
using RumbleModUI;
using static RumbleModdingAPI.Calls.GameObjects.Gym.Tutorial.WorldTutorials.CombatCarvings.Collisions.CarvingFoot;
using Il2CppRUMBLE.Combat.ShiftStones;

using BuildInfo = BlindRumble.BuildInfo;
...
namespace BlindRumble
{
    ...
    public class Class1 : MelonMod
    {
        ...
        public override void OnLateUpdate()
        {
            ...
            if (enemyHealth != null && enemyPlayer != null && enemyHealthAmount != null && currentSceneName != "Gym" && currentSceneName != "Loader" && playerHealth != null)
            {
                ...
                if (enemyPlayer.Data.HealthPoints != enemyHealthAmount)
                {
                    ...
                    enemyHealth.transform.GetComponent<PlayerHealth>().UpdateLocalHealthbarPercentage(enemyPlayer.Data.HealthPoints, enemyHealthAmount, true);
                    try
                    {
                    ...
                    if (enemyPlayer.Data.HealthPoints < enemyHealthAmount)
                    {
                        ...
                        Class1.ActivateSonar(enemyPlayer.Controller.transform.GetChild(1).GetChild(0).GetChild(0).position, 5f, poolParent, overlappedObjects, false);
                    }
        ...
        private void ChangePlayerMaterial(GameObject modelTransform, bool IsLocalPlayer)
        {
        ...
        private void DisableRenderersWithSwitch(Transform parent, bool isGym)
        {
            ...
            GameObject poolManagerObject = Calls.GameObjects.DDOL.GameInstance.PreInitializable.GetGameObject().transform.GetChild(1).gameObject;
        ...
        private IEnumerator DelayCharacterTransformation(string currentScene, bool IsLocalPlayer = true)
        {
            if (currentScene != "Loader" && currentScene != "")
            {
                ...
                if (currentScene == "Gym")
                {
                    ...
                    Transform visualsTransform = Calls.Managers.GetPlayerManager().localPlayer.Controller.transform.GetChild(0);
                ...
                if ((bool)((ModSetting)modEnabledUI).SavedValue && IsLocalPlayer)
                {
                    ...
                    if (currentScene == "Park" || (friendQueue && currentScene.Contains("Map")) || (currentScene.Contains("Map") && Calls.Mods.doesOpponentHaveMod("BlindRumble", BuildInfo.ModVersion, false)) || (currentScene.Contains("Map") && modEnabledAllTime))
                    {
                            ...
                            if (playerManager1 != null && playerManager1.AllPlayers != null)
                            {
                                for (int index = 0; index < playerManager1.AllPlayers.Count; index++)
                                {
                                    ...
                                    if (player != null && player.Controller != null && player.Controller.name == "Player Controller(Clone)")
                                    {
                                        ...
                                        GameObject dummyPlayer = GameObject.Instantiate(Calls.Managers.GetPlayerManager().playerControllerPrefab.gameObject);
                                        ...
                                        enemyHealth.transform.GetComponent<PlayerHealth>().ActivateLocalHealthBar();
                                        ...
                                        enemyHealth.transform.GetComponent<PlayerHealth>().UpdateLocalHealthbarPercentage(enemyHealthAmount, 20, true);
                                        try
                                        {
                                            enemyHealth.transform.GetComponent<PlayerHealth>().UpdateLocalHealthBar();
                                        }
                ...
                if (currentScene == "Gym")
                {
                    ...
                    GameObject armMesh = Calls.GameObjects.Gym.Logic.HeinhouserProducts.MoveLearning.Ghost.Visuals.HandLPoseGhost.GetGameObject();
                    GameObject regionEurope = Calls.GameObjects.Gym.Logic.HeinhouserProducts.RegionSelector.GetGameObject().transform.Find("Model/WorldMap/Regions_Effectmesh/Region_Europe.002").gameObject;
                    
                    GameObject glassPane = Calls.GameObjects.Gym.Logic.HeinhouserProducts.ShiftstoneCabinet.Glassplane.GetGameObject();

                    if (armMesh != null && regionEurope != null && !newParent.transform.Find("WhiteGhostPoseObject"))
                    {
                        GameObject newParent = Calls.GameObjects.DDOL.GameInstance.GetGameObject();
                        if (newParent != null)
                        {
                ...
                else if (currentScene == "Park" && modEnabled)
                {
                    ...
                    Calls.GameObjects.Park.LightingAndEffects.GetGameObject().SetActive(false);
                    Calls.GameObjects.Park.Scene.Mountains.GetGameObject().SetActive(false);


                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.HubFloor.GetGameObject().SetActive(false);
                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Leaves.GetGameObject().SetActive(false);
                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Root.GetGameObject().SetActive(false);
                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Wood.GetGameObject().SetActive(false);

                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena0.ArenaMetalRim.GetGameObject().SetActive(false);
                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena0.RingClamp.GetGameObject().SetActive(false);
                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena0.Rocks.GetGameObject().SetActive(false);

                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena1.Rocks.GetGameObject().SetActive(false);
                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena2.Rocks.GetGameObject().SetActive(false);
                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena3.Rocks.GetGameObject().SetActive(false);
                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena4.Rocks.GetGameObject().SetActive(false);

                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena5.Rocks.GetGameObject().SetActive(false);
                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena5.ArenaMetalRim.GetGameObject().SetActive(false);
                    Calls.GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena5.Arena.GetGameObject().SetActive(false);



                    Calls.GameObjects.Park.Scene.Park.SubStaticGroup.Pedistals.GetGameObject().SetActive(false);
                    Calls.GameObjects.Park.Scene.Park.SubStaticGroup.Rocks.GetGameObject().SetActive(false);
                    ...
                    Renderer[] renderers = Calls.GameObjects.Park.Scene.Park.GetGameObject().transform.parent.GetComponentsInChildren<Renderer>();
                    ...
                    Renderer[] renderers1 = Calls.GameObjects.Park.Logic.GetGameObject().transform.GetComponentsInChildren<Renderer>();
                    ...
                    Renderer[] renderers2 = Calls.GameObjects.Park.Logic.HeinhouserProducts.GetGameObject().transform.GetComponentsInChildren<Renderer>();
                    ...
                    Calls.GameObjects.Park.Logic.ShiftstoneQuickswapper.LeftHandSlab.GetGameObject().transform.GetComponent<Renderer>().material = regionMaterial;
                    Calls.GameObjects.Park.Logic.ShiftstoneQuickswapper.RightHandSlab.GetGameObject().transform.GetComponent<Renderer>().material = regionMaterial;

                    Calls.GameObjects.Park.Logic.ParkToys.MatchCounter.Scoreboard.FirstPlayerNameUI.Text.GetGameObject().transform.GetComponent<TextMeshProUGUI>().color = new Color(0.5f, 0.5f, 0.5f, 1f);
                    Calls.GameObjects.Park.Logic.ParkToys.MatchCounter.Scoreboard.SecondPlayerNameUI.Text.GetGameObject().transform.GetComponent<TextMeshProUGUI>().color = new Color(0.5f, 0.5f, 0.5f, 1f);
                    Calls.GameObjects.Park.Logic.ParkToys.MatchCounter.Scoreboard.FirstPlayerScoreUI.Text.GetGameObject().transform.GetComponent<TextMeshProUGUI>().color = new Color(0.5f, 0.5f, 0.5f, 1f);
                    Calls.GameObjects.Park.Logic.ParkToys.MatchCounter.Scoreboard.SecondPlayerScoreUI.Text.GetGameObject().transform.GetComponent<TextMeshProUGUI>().color = new Color(0.5f, 0.5f, 0.5f, 1f);

                    Calls.GameObjects.Park.Logic.ParkToys.MatchCounter.Scoreboard.RestScoreUI.Text.GetGameObject().transform.GetComponent<TextMeshProUGUI>().color = new Color(0.5f, 0.5f, 0.5f, 1f);
                }
                else if (currentScene == "Map0" && Calls.GameObjects.Map0.Map0Production.Mountain.GetGameObject().active == true && modEnabled)
                {

                    Calls.GameObjects.Map0.LightingAndEffects.GetGameObject().SetActive(false);
                    Calls.GameObjects.Map0.Map0Production.Mountain.GetGameObject().SetActive(false);

                    Calls.GameObjects.Map0.Map0Production.MainStaticGroup.BackgroundPlane.GetGameObject().SetActive(false);
                    Calls.GameObjects.Map0.Map0Production.MainStaticGroup.BackgroundRocks.GetGameObject().SetActive(false);
                    Calls.GameObjects.Map0.Map0Production.MainStaticGroup.CombatFloor.GetGameObject().SetActive(false);
                    Calls.GameObjects.Map0.Map0Production.MainStaticGroup.Leaves.GetGameObject().SetActive(false);
                    Calls.GameObjects.Map0.Map0Production.MainStaticGroup.Root.GetGameObject().SetActive(false);

                    Calls.GameObjects.Map0.Map0Production.GetGameObject().transform.GetChild(0).GetChild(2).GetChild(1).gameObject.GetComponent<Renderer>().enabled = false;
                    ...
                    Renderer[] renderers = Calls.GameObjects.Map0.Map0Production.MainStaticGroup.GetGameObject().transform.GetComponentsInChildren<Renderer>();
                    ...
                    Calls.GameObjects.Map0.Logic.Pedestals.MatchPedestalP1.VFX.DustPedestalLift.GetGameObject().GetComponent<VisualEffect>().enabled = false;
                    Calls.GameObjects.Map0.Logic.Pedestals.MatchPedestalP1.VFX.DustPedestalRelocate.GetGameObject().GetComponent<VisualEffect>().enabled = false;
                    Calls.GameObjects.Map0.Logic.Pedestals.MatchPedestalP1.VFX.DustPedestalSink.GetGameObject().GetComponent<VisualEffect>().enabled = false;
                    Calls.GameObjects.Map0.Logic.Pedestals.MatchPedestalP1.VFX.DustPedestalSpawn.GetGameObject().GetComponent<VisualEffect>().enabled = false;

                    Renderer[] renderers1 = Calls.GameObjects.Map0.Logic.Pedestals.MatchPedestalP1.GetGameObject().transform.GetComponentsInChildren<Renderer>();
                    ...
                    Calls.GameObjects.Map0.Logic.Pedestals.MatchPedestalP2.VFX.DustPedestalLift.GetGameObject().GetComponent<VisualEffect>().enabled = false;
                    Calls.GameObjects.Map0.Logic.Pedestals.MatchPedestalP2.VFX.DustPedestalRelocate.GetGameObject().GetComponent<VisualEffect>().enabled = false;
                    Calls.GameObjects.Map0.Logic.Pedestals.MatchPedestalP2.VFX.DustPedestalSink.GetGameObject().GetComponent<VisualEffect>().enabled = false;
                    Calls.GameObjects.Map0.Logic.Pedestals.MatchPedestalP2.VFX.DustPedestalSpawn.GetGameObject().GetComponent<VisualEffect>().enabled = false;

                    Renderer[] renderers2 = Calls.GameObjects.Map0.Logic.Pedestals.MatchPedestalP2.GetGameObject().transform.GetComponentsInChildren<Renderer>();
                    ...
                    //MATCH SLAB ONE
                    //GRAPHICS SLAB
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.FloarRock0.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.FloatRock1.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;

                    var materials1 = Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.MeshGraphicsSlab.GetGameObject().GetComponent<Renderer>().materials;

                    materials1[0] = yellowGhostPoseMaterial;
                    materials1[1] = yellowGhostPoseMaterial;

                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.MeshGraphicsSlab.GetGameObject().GetComponent<Renderer>().materials = materials1;

                    //REPLAY BUTTON
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.SlabRockFloat.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionButton.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionButton.Button.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionButton.Button.Spring.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;

                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.GetGameObject().transform.GetChild(2).gameObject.GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);

                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightLocal.Light.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightLocal.LightPlug.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;

                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightNetworked.Light.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightNetworked.LightPlug.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;

                    //RE-QUEUE BUTTON
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.SlabRockFloat.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.InteractionButton.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.InteractionButton.Button.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.InteractionButton.Button.Spring.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;


                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.GetGameObject().transform.GetChild(2).gameObject.GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);


                    //EXIT MATCH BUTTON
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.SlabRockFloat.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.InteractionButton.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.InteractionButton.Button.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.InteractionButton.Button.Spring.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;


                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.GetGameObject().transform.GetChild(2).gameObject.GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);



                    //SHIFTSTONE SWAPPER
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(0).gameObject.GetComponent<Renderer>().material = glassMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(1).gameObject.GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);

                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(2).gameObject.GetComponent<Renderer>().material = glassMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(2).GetChild(0).gameObject.GetComponent<Renderer>().material = glassMaterial;

                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(2).GetChild(0).GetChild(2).gameObject.GetComponent<Renderer>().material = glassMaterial;

                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.LeftHandSlab.GetGameObject().gameObject.GetComponent<Renderer>().material = regionMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.RightHandSlab.GetGameObject().gameObject.GetComponent<Renderer>().material = regionMaterial;
                    ...
                    //MATCH SLAB TWO
                    //GRAPHICS SLAB
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.FloarRock0.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.FloatRock1.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;

                    var materials2 = Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.MeshGraphicsSlab.GetGameObject().GetComponent<Renderer>().GetComponent<Renderer>().materials;

                    materials2[0] = yellowGhostPoseMaterial;
                    materials2[1] = yellowGhostPoseMaterial;

                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.MeshGraphicsSlab.GetGameObject().GetComponent<Renderer>().materials = materials2;

                    //REPLAY BUTTON
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.SlabRockFloat.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionButton.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionButton.Button.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionButton.Button.Spring.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;


                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.RePlayText.GetGameObject().GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);

                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightLocal.Light.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightLocal.LightPlug.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;

                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightNetworked.Light.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightNetworked.LightPlug.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;


                    //RE-QUEUE BUTTON
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.SlabRockFloat.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.InteractionButton.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.InteractionButton.Button.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.InteractionButton.Button.Spring.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;


                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.ReQueueText.GetGameObject().GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);


                    //EXIT MATCH BUTTON
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.SlabRockFloat.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.InteractionButton.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.InteractionButton.Button.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.InteractionButton.Button.Spring.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;


                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.RePlayText.GetGameObject().GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);



                    //SHIFTSTONE SWAPPER
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(0).gameObject.GetComponent<Renderer>().material = glassMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(1).gameObject.GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);

                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(2).gameObject.GetComponent<Renderer>().material = glassMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(2).GetChild(0).gameObject.GetComponent<Renderer>().material = glassMaterial;

                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(2).GetChild(0).GetChild(2).gameObject.GetComponent<Renderer>().material = glassMaterial;

                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.LeftHandSlab.GetGameObject().gameObject.GetComponent<Renderer>().material = regionMaterial;
                    Calls.GameObjects.Map0.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.RightHandSlab.GetGameObject().gameObject.GetComponent<Renderer>().material = regionMaterial;
                ...
                else if (currentScene == "Map1" && Calls.GameObjects.Map1.Map1Production.MainStaticGroup.DeathDirt.GetGameObject().active == true && modEnabled)
                {
                    Calls.GameObjects.Map1.LightingAndEffects.GetGameObject().SetActive(false);


                    Calls.GameObjects.Map1.Map1Production.MainStaticGroup.CombatFloor.GetGameObject().SetActive(false);
                    Calls.GameObjects.Map1.Map1Production.MainStaticGroup.DeathDirt.GetGameObject().SetActive(false);
                    Calls.GameObjects.Map1.Map1Production.MainStaticGroup.Leaves.GetGameObject().SetActive(false);
                    Calls.GameObjects.Map1.Map1Production.MainStaticGroup.OuterBoundry.GetGameObject().SetActive(false);
                    ...
                    Renderer[] renderers = Calls.GameObjects.Map1.Map1Production.MainStaticGroup.GetGameObject().transform.GetComponentsInChildren<Renderer>();
                    ...
                    Calls.GameObjects.Map1.Logic.Pedestals.MatchPedestalP1.VFX.DustPedestalLift.GetGameObject().GetComponent<VisualEffect>().enabled = false;
                    Calls.GameObjects.Map1.Logic.Pedestals.MatchPedestalP1.VFX.DustPedestalRelocate.GetGameObject().GetComponent<VisualEffect>().enabled = false;
                    Calls.GameObjects.Map1.Logic.Pedestals.MatchPedestalP1.VFX.DustPedestalSink.GetGameObject().GetComponent<VisualEffect>().enabled = false;
                    Calls.GameObjects.Map1.Logic.Pedestals.MatchPedestalP1.VFX.DustPedestalSpawn.GetGameObject().GetComponent<VisualEffect>().enabled = false;

                    Renderer[] renderers1 = Calls.GameObjects.Map1.Logic.Pedestals.MatchPedestalP1.GetGameObject().transform.GetComponentsInChildren<Renderer>();
                    ...
                    Calls.GameObjects.Map1.Logic.Pedestals.MatchPedestalP2.VFX.DustPedestalLift.GetGameObject().GetComponent<VisualEffect>().enabled = false;
                    Calls.GameObjects.Map1.Logic.Pedestals.MatchPedestalP2.VFX.DustPedestalRelocate.GetGameObject().GetComponent<VisualEffect>().enabled = false;
                    Calls.GameObjects.Map1.Logic.Pedestals.MatchPedestalP2.VFX.DustPedestalSink.GetGameObject().GetComponent<VisualEffect>().enabled = false;
                    Calls.GameObjects.Map1.Logic.Pedestals.MatchPedestalP2.VFX.DustPedestalSpawn.GetGameObject().GetComponent<VisualEffect>().enabled = false;

                    Renderer[] renderers2 = Calls.GameObjects.Map1.Logic.Pedestals.MatchPedestalP2.GetGameObject().transform.GetComponentsInChildren<Renderer>();
                    ...
                    //MATCH SLAB ONE
                    //GRAPHICS SLAB
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.FloarRock0.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.FloatRock1.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;

                    var materials1 = Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.MeshGraphicsSlab.GetGameObject().GetComponent<Renderer>().materials;

                    materials1[0] = yellowGhostPoseMaterial;
                    materials1[1] = yellowGhostPoseMaterial;

                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.MeshGraphicsSlab.GetGameObject().GetComponent<Renderer>().materials = materials1;

                    //REPLAY BUTTON
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.SlabRockFloat.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionButton.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionButton.Button.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionButton.Button.Spring.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;

                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.GetGameObject().transform.GetChild(2).gameObject.GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);

                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightLocal.Light.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightLocal.LightPlug.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;

                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightNetworked.Light.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightNetworked.LightPlug.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;

                    //RE-QUEUE BUTTON
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.SlabRockFloat.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.InteractionButton.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.InteractionButton.Button.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.InteractionButton.Button.Spring.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;


                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.GetGameObject().transform.GetChild(2).gameObject.GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);


                    //EXIT MATCH BUTTON
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.SlabRockFloat.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.InteractionButton.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.InteractionButton.Button.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.InteractionButton.Button.Spring.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;


                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.GetGameObject().transform.GetChild(2).gameObject.GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);



                    //SHIFTSTONE SWAPPER
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(0).gameObject.GetComponent<Renderer>().material = glassMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(1).gameObject.GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);

                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(2).gameObject.GetComponent<Renderer>().material = glassMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(2).GetChild(0).gameObject.GetComponent<Renderer>().material = glassMaterial;

                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(2).GetChild(0).GetChild(2).gameObject.GetComponent<Renderer>().material = glassMaterial;

                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.LeftHandSlab.GetGameObject().gameObject.GetComponent<Renderer>().material = regionMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabOne.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.RightHandSlab.GetGameObject().gameObject.GetComponent<Renderer>().material = regionMaterial;
                    ...
                    //MATCH SLAB TWO
                    //GRAPHICS SLAB
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.FloarRock0.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.FloatRock1.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;

                    var materials2 = Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.MeshGraphicsSlab.GetGameObject().GetComponent<Renderer>().GetComponent<Renderer>().materials;

                    materials2[0] = yellowGhostPoseMaterial;
                    materials2[1] = yellowGhostPoseMaterial;

                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.GraphicsSlab.Mesh.MeshGraphicsSlab.GetGameObject().GetComponent<Renderer>().materials = materials2;

                    //REPLAY BUTTON
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.SlabRockFloat.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionButton.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionButton.Button.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionButton.Button.Spring.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;


                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.RePlayText.GetGameObject().GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);

                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightLocal.Light.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightLocal.LightPlug.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;

                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightNetworked.Light.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.RePlayButton.InteractionLightNetworked.LightPlug.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;


                    //RE-QUEUE BUTTON
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.SlabRockFloat.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.InteractionButton.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.InteractionButton.Button.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.InteractionButton.Button.Spring.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;


                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ReQueueButton.ReQueueText.GetGameObject().GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);


                    //EXIT MATCH BUTTON
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.SlabRockFloat.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.InteractionButton.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.InteractionButton.Button.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.InteractionButton.Button.Spring.GetGameObject().GetComponent<Renderer>().material = yellowGhostPoseMaterial;


                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ExitMatchButton.RePlayText.GetGameObject().GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);



                    //SHIFTSTONE SWAPPER
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(0).gameObject.GetComponent<Renderer>().material = glassMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(1).gameObject.GetComponent<TextMeshPro>().color = new Color(0.5f, 0.5f, 0.5f, 1f);

                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(2).gameObject.GetComponent<Renderer>().material = glassMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(2).GetChild(0).gameObject.GetComponent<Renderer>().material = glassMaterial;

                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.FloatingButton.GetGameObject().transform.GetChild(2).GetChild(0).GetChild(2).gameObject.GetComponent<Renderer>().material = glassMaterial;

                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.LeftHandSlab.GetGameObject().gameObject.GetComponent<Renderer>().material = regionMaterial;
                    Calls.GameObjects.Map1.Logic.MatchSlabTwo.MatchSlab.SlabBuddyMatchVariant.MatchForm.ShiftstoneQuickswapper.RightHandSlab.GetGameObject().gameObject.GetComponent<Renderer>().material = regionMaterial;
        ...
        private IEnumerator YellowGhostPoseCloningCoroutine()
        {
            ...
            newParent = Calls.GameObjects.DDOL.GameInstance.GetGameObject();
        ...
        private IEnumerator SonarEnumerator(Transform structureTransform, float targetSize, Transform poolParent, List<GameObject> initialOverlaps, bool collidedWithMap = false, int delay = 0)
        {
        ...
        public void RenderClone(GameObject original, Transform poolParent, bool collidedWithMap = false, bool ignoreRendererEnabled = false, bool addToCloneList = true, bool playerCollisionClone = false)
        {
            ...
            GameObject localController = Calls.Managers.GetPlayerManager().localPlayer.Controller.gameObject;
                ...
                if ((original == null || !original.active) && clone != null && collidedWithMap == true || (original == null || !original.active) && clone != null && playerCollisionClone == true)
                {
                    ...
                    if (!destroyPositionSet)
                    {
                        ...
                        if (playerCollisionClone)
                        {
                            ...
                            Class1.ActivateSonar(clone.transform.position, 5f, poolParent, overlappedObjects, false);
                        }
                    }
        ...
        private static Transform IsDescendantOf(Transform child, Transform poolParent, bool checkingForStructure, bool checkingForVisuals, List<GameObject> processedVisuals = null, bool notInstafillProcessedVisuals = false, bool collisionCheck = false)
        {
        ...
        private IEnumerator HoldStart(Transform poolParent, UnityEngine.Vector3 startPosition, float targetSize, bool isLocalPlayer, bool isHold)
        {
            if (!modEnabled)
            {
                yield break;
        ...
        public static class StructureSpawn
        {
            private static void Postfix(ref Il2CppRUMBLE.MoveSystem.Structure __instance)
            {
                ...
                try
                {
                    ...
                    {
                        var testMaterial = newParent.transform.Find("YellowGhostPoseObject").gameObject.GetComponent<Renderer>().material;
        ...
        public static class StructureRespawn
        {
            private static void Postfix(ref Il2CppRUMBLE.MoveSystem.Structure __instance)
            {
                ...
                GameObject controller = Calls.Managers.GetPlayerManager().localPlayer.Controller.gameObject;
                Transform poolParent = Calls.Pools.Structures.GetPoolCube().transform.parent;
        ...
        private static class Stack_Execute_Patch
        {
            private static void Postfix(Il2CppRUMBLE.MoveSystem.Stack __instance, Il2CppRUMBLE.MoveSystem.IProcessor processor)
            {
                ...
                try
                {
                    if (__instance.cachedName == "Jump" && midair == false && processor.Cast<Il2CppRUMBLE.MoveSystem.PlayerStackProcessor>() == PlayerManager.instance.localPlayer.Controller.GetSubsystem<Il2CppRUMBLE.MoveSystem.PlayerStackProcessor>())
                    {
                        midair = true;
                    }
                }
        ...
        public static class StructureCollisionEvent
        {
            private static void Prefix(Collision collision)
            {
                ...
                if (IsDescendantOf(collision.GetContact(0).thisCollider.gameObject.transform, poolParent, false, true, processedVisuals, false, true) && collision.contactCount == 1 || IsDescendantOf(collision.GetContact(0).otherCollider.gameObject.transform, poolParent, false, true, processedVisuals, false, true) && collision.contactCount == 1)
                {
        ...
        public static class HoldStartEvent
        {
            private static void Postfix(Il2CppRUMBLE.MoveSystem.HoldModifier __instance, Il2CppRUMBLE.MoveSystem.IProcessor processor, Il2CppRUMBLE.MoveSystem.StackConfiguration config)// //Il2CppRUMBLE.MoveSystem.Stack __instance,
            {
                ...
                if (modInstance != null)
                {
                    ...
                    var localPlayer = Calls.Managers.GetPlayerManager().localPlayer;
        ...
        private static class PlayerMovement_OnBecameGrounded_Patch
        {
            private static void Postfix(PlayerMovement __instance)
            {
                ...
                Class1.ActivateSonar(Calls.Managers.GetPlayerManager().localPlayer.Controller.transform.position, 1000f, poolParent, overlappedObjects);
        ...
        public static class ShiftstonePatch
        {
            ...
            {
                var modInstance = MelonLoader.MelonMod.RegisteredMelons.FirstOrDefault(m => m is Class1) as Class1;
                if (modInstance == null && currentSceneName != "Loader")
                {
                    return;
                }
        ...
        public static class FistbumpPatch
        {
            private static void Postfix(PlayerBoxInteractionTrigger first, PlayerBoxInteractionTrigger second)
            {
                ...
                if (modEnabled == false || Class1.bodyMaterial == null)
                {
                    return;
                }
